...
char *mu_1_MessageType::values[] = {"GetS","GetM","PutS","PutM","Data","InvAck","PutAck","InvAllAck","Inv","FwdGetS","FwdGetM","FwdGetSAck","FwdGetMAck",NULL };
...
class mu_1__type_0: public mu__byte
{
 public:
  ...
  mu_1__type_0 (char *name, int os): mu__byte(20, 27, 4, name, os) {};
  mu_1__type_0 (void): mu__byte(20, 27, 4) {};
  mu_1__type_0 (int val): mu__byte(20, 27, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1__type_0::values[] = {"Dir_M","Dir_S","Dir_I","Dir_MS_D","Dir_MM_A","Dir_MS_DA","Dir_SM_A","Dir_MX_A",NULL };
...
bool mu__boolexpr16;
  if (!(mu_IsSharer( mu_msg.mu_src ))) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = ((mu_cnt) == (1)) ; 
}
if ( mu__boolexpr16 )
{
mu_DirNode.mu_state = mu_Dir_M;
...
bool mu__boolexpr17;
bool mu__boolexpr18;
  if (!((mu_msg.mu_ack_cnt) == (0))) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = ((mu_msg.mu_src) == (mu_Directory)) ; 
}
  if (mu__boolexpr18) mu__boolexpr17 = TRUE ;
  else {
  mu__boolexpr17 = ((mu_DirNode.mu_owner) == (mu_msg.mu_src)) ; 
}
if ( mu__boolexpr17 )
{
mu_pstate = mu_Proc_S;
...
/********************
  Invariant records
 ********************/
int mu__invariant_19() // Invariant "Invalid Processors are not present on Sharer's List"
{
bool mu__quant20; 
mu__quant20 = TRUE;
{
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_DirNode.mu_sharers.valid[(int)mu_i].value())
        {
          if ( (mu_DirNode.mu_sharers[mu_i]) == (mu_n) ) mu__intexpr22++;
        }
      if (mu_i == 3-1) break;
    }
  }
...
bool mu__condition_23() // Condition for Rule "Invalid Processors are not present on Sharer's List"
{
...
int mu__invariant_24() // Invariant "If processor is in Modified state, there are no Sharers"
{
bool mu__quant25; 
mu__quant25 = TRUE;
{
...
bool mu__boolexpr27;
bool mu__boolexpr28;
  if (!((mu_Procs[mu_n].mu_state) == (mu_Proc_M))) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = ((mu_n) != (mu_m)) ; 
}
  if (!(mu__boolexpr28)) mu__boolexpr27 = TRUE ;
  else {
bool mu__boolexpr29;
  if (!((mu_Procs[mu_m].mu_state) != (mu_Proc_S))) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_Procs[mu_m].mu_state) != (mu_Proc_M)) ; 
}
  mu__boolexpr27 = (mu__boolexpr29) ; 
}
if ( !(mu__boolexpr27) )
...
bool mu__condition_30() // Condition for Rule "If processor is in Modified state, there are no Sharers"
{
...
int mu__invariant_31() // Invariant "Processors in a valid state (S or M) match last write"
{
bool mu__quant32; 
mu__quant32 = TRUE;
{
...
bool mu__boolexpr33;
bool mu__boolexpr34;
  if ((mu_Procs[mu_n].mu_state) == (mu_Proc_S)) mu__boolexpr34 = TRUE ;
  else {
  mu__boolexpr34 = ((mu_Procs[mu_n].mu_state) == (mu_Proc_M)) ; 
}
  if (!(mu__boolexpr34)) mu__boolexpr33 = TRUE ;
  else {
  mu__boolexpr33 = ((mu_Procs[mu_n].mu_value) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr33) )
...
bool mu__condition_35() // Condition for Rule "Processors in a valid state (S or M) match last write"
{
...
int mu__invariant_36() // Invariant "Values in memory matches value of last write, when shared or invalid"
{
bool mu__quant37; 
mu__quant37 = TRUE;
{
...
bool mu__boolexpr38;
bool mu__boolexpr39;
  if ((mu_DirNode.mu_state) == (mu_Dir_S)) mu__boolexpr39 = TRUE ;
  else {
  mu__boolexpr39 = ((mu_DirNode.mu_state) == (mu_Dir_I)) ; 
}
  if (!(mu__boolexpr39)) mu__boolexpr38 = TRUE ;
  else {
  mu__boolexpr38 = ((mu_DirNode.mu_value) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr38) )
...
bool mu__condition_40() // Condition for Rule "Values in memory matches value of last write, when shared or invalid"
{
...
int mu__invariant_41() // Invariant "Processor in I state implies the value is undefined"
{
bool mu__quant42; 
mu__quant42 = TRUE;
{
...
bool mu__boolexpr43;
  ...
  mu__boolexpr43 = (mu_Procs[mu_n].mu_value.isundefined()) ; 
}
if ( !(mu__boolexpr43) )
...
bool mu__condition_44() // Condition for Rule "Processor in I state implies the value is undefined"
{
...
int mu__invariant_45() // Invariant "Processor in S state implies the value match memory"
{
bool mu__quant46; 
mu__quant46 = TRUE;
{
...
bool mu__boolexpr47;
bool mu__boolexpr48;
  if (!((mu_DirNode.mu_state) == (mu_Dir_S))) mu__boolexpr48 = FALSE ;
  else {
  mu__boolexpr48 = ((mu_Procs[mu_n].mu_state) == (mu_Proc_S)) ; 
}
  if (!(mu__boolexpr48)) mu__boolexpr47 = TRUE ;
  else {
  mu__boolexpr47 = ((mu_DirNode.mu_value) == (mu_Procs[mu_n].mu_value)) ; 
}
if ( !(mu__boolexpr47) )
...
bool mu__condition_49() // Condition for Rule "Processor in S state implies the value match memory"
{
...
int mu__invariant_50() // Invariant "Directory in S state implies non-empty sharer list"
{
bool mu__boolexpr51;
  if (!((mu_DirNode.mu_state) == (mu_Dir_S))) mu__boolexpr51 = TRUE ;
  else {
...
/*** end multisetcount 6 declaration ***/
  mu__boolexpr51 = ((mu__intexpr52) > (0)) ; 
}
return mu__boolexpr51;
};

bool mu__condition_53() // Condition for Rule "Directory in S state implies non-empty sharer list"
{
...
int mu__invariant_54() // Invariant "Directory in I or M state implies empty sharer list"
{
bool mu__boolexpr55;
bool mu__boolexpr56;
  if ((mu_DirNode.mu_state) == (mu_Dir_I)) mu__boolexpr56 = TRUE ;
  else {
  mu__boolexpr56 = ((mu_DirNode.mu_state) == (mu_Dir_M)) ; 
}
...
/*** end multisetcount 5 declaration ***/
  mu__boolexpr55 = ((mu__intexpr57) == (0)) ; 
}
return mu__boolexpr55;
};

bool mu__condition_58() // Condition for Rule "Directory in I or M state implies empty sharer list"
{
...
int mu__invariant_59() // Invariant "Directory in M state implies owner exists"
{
bool mu__boolexpr60;
  if (!((mu_DirNode.mu_state) == (mu_Dir_M))) mu__boolexpr60 = TRUE ;
  else {
...
bool mu__condition_61() // Condition for Rule "Directory in M state implies owner exists"
{
...
int mu__invariant_62() // Invariant "Directory in I or S state implies empty owner"
{
bool mu__boolexpr63;
bool mu__boolexpr64;
  if ((mu_DirNode.mu_state) == (mu_Dir_I)) mu__boolexpr64 = TRUE ;
  else {
  mu__boolexpr64 = ((mu_DirNode.mu_state) == (mu_Dir_S)) ; 
}
  if (!(mu__boolexpr64)) mu__boolexpr63 = TRUE ;
  else {
  mu__boolexpr63 = ((mu_DirNode.mu_owner) == (mu_Directory)) ; 
}
return mu__boolexpr63;
};

bool mu__condition_65() // Condition for Rule "Directory in I or S state implies empty owner"
{
...
{"Directory in I or S state implies empty owner", &mu__condition_65, NULL, FALSE},
{"Directory in M state implies owner exists", &mu__condition_61, NULL, FALSE},
{"Directory in I or M state implies empty sharer list", &mu__condition_58, NULL, FALSE},
{"Directory in S state implies non-empty sharer list", &mu__condition_53, NULL, FALSE},
{"Processor in S state implies the value match memory", &mu__condition_49, NULL, FALSE},
{"Processor in I state implies the value is undefined", &mu__condition_44, NULL, FALSE},
{"Values in memory matches value of last write, when shared or invalid", &mu__condition_40, NULL, FALSE},
{"Processors in a valid state (S or M) match last write", &mu__condition_35, NULL, FALSE},
{"If processor is in Modified state, there are no Sharers", &mu__condition_30, NULL, FALSE},
{"Invalid Processors are not present on Sharer's List", &mu__condition_23, NULL, FALSE},
};
