...
type
  ...
  DirState: -- Directory controller states
    Record
      ...
      fwd_flag: array [Proc] of boolean;
    End;
...
--  put " at home -- "; put DirNode.state;
  ...
  case Dir_M:
    ...
    case PutM:
      ...
      -- if DirNode.fwd_flag[msg.src] = false then
        Send(PutAck, msg.src, Directory, ResponseChannel, UNDEFINED, UNDEFINED, 0);
      -- endif;
    -- case FwdGetSAck:
    --   DirNode.fwd_flag[msg.src] := false;
    else
      ErrorUnhandledMsg(msg, Directory);
    endswitch;
...
--  put " at proc "; put p; put "\n";
  ...
  case Proc_M:
    ...
    case FwdGetS:
      ...
      Send(FwdGetSAck, Directory,  p, ForwardChannel, UNDEFINED, UNDEFINED, 0);
      Send(Data, msg.fwd_to, p, ResponseChannel, pvalue, UNDEFINED, 0);
    case FwdGetM:
      pstate := Proc_I;
      Send(Data, msg.fwd_to, p, ResponseChannel, pvalue, UNDEFINED, 0);
      Send(FwdGetMAck, Directory,  p, ForwardChannel, UNDEFINED, UNDEFINED, 0);
      undefine pvalue;
    else
      ErrorUnhandledMsg(msg, p);
    endswitch;
